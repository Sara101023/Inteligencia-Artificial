...
from collections import deque #Importo deque porque BFS utiliza una cola (queue) y deque es una estructura eficiente para insertar y eliminar elementos.
from dataclasses import dataclass
from typing import Callable, Deque, Dict, Generic, Hashable, Iterable, List, Optional, Set, Tuple, TypeVar

S = TypeVar("S", bound=Hashable)

@dataclass#guarda los resultaods de busqueda
...
def bfs(start: S, is_goal: Callable[[S], bool], neighbors: Callable[[S], Iterable[S]]) -> SearchResult[S]:
    ...
    exploration_order = []#animar el algoritmo en la interfaz gráfica.
